...
async function main() {
  await fetchUser(`MatheusSchiavao`)
  await fetchUser(`TheVarella`)
  await fetchUser(`alexborgessjc`)
  await fetchUser(`DaviSFS21`)
  await fetchUser(`ViniElias`)
  await fetchUser(`NicoleRabello`)
  await fetchUser(`davismartuch`)

  await showUser(`MatheusSchiavao`)
  await showUser(`TheVarella`)
  await showUser(`alexborgessjc`)
  await showUser(`DaviSFS21`)
  await showUser(`ViniElias`)
  await showUser(`NicoleRabello`)
  await showUser(`davismartuch`)
